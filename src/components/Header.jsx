    ...
    return (
        <header>
            <div className="container">
                ...
                <nav>
                    <ul>
                        <li><a href="https://www.instagram.com/idtilua/">
                            <svg className={styles.instagram} xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="transparent">
